...
from exportapp.views import editarformula,registrarvalor,busqueda,ingresarindividual,registrarindividual,realizar_consulta,iniciar_sesion,consultar_exportacion,consultarmodifica,top10,eliminar,modificarexportacion,validar,actualizar_exportacion,ingresarmasivo,ingresar_datos
...
urlpatterns = [
   ...
   #################################################
   ##################modificar formula################
   url(r'^cambiarformula/',editarformula),
   url(r'^registrarcoeficiente/',registrarvalor),
   
   
  ##############ingreso individual################
   url(r'^ingresar/',ingresarindividual),
   url(r'^registrarexportacion/',registrarindividual),
